    ...
    >
      ...
      {!isViewMode && !hideToolbar && (
        <Box sx={{
          ...
          {/* Split Screen Toggle - Eye icon */}
          <Tooltip title={isSplitScreen ? "Close Split Screen" : "Open Split Screen"}>
            <IconButton
              onClick={onPreviewToggle}
              sx={{
                backgroundColor: isSplitScreen ? '#4caf50' : '#607d8b',
                color: 'white',
                '&:hover': { backgroundColor: isSplitScreen ? '#45a049' : '#546e7a' },
                width: { xs: 36, sm: 40 },
                height: { xs: 36, sm: 40 },
              }}
            >
